...
//
  ...
  G4double detector_dZ = 1 * cm;   // Kích thước theo trục Z
  ...
  new G4PVPlacement(nullptr,  // Không xoay
      G4ThreeVector(0, 0, 5.5 * cm),  // Vị trí (0, 0, 0)
  ...
  auto solidCompSi = new G4Box("Patient", compSi_X / 2, compSi_Y / 2, detector_dZ / 2);
